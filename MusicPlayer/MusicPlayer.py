...
root=Tk()
root.title('Simple Music Player of Python')
root.geometry('485x700+290+10')
root.configure(background='#833332')
...
#panel=Label(root, image=Volume1, bg="#FFFFFF",bd=0, height=60, width=60,command=mixer.music.unpause).place(x=20,y=487)
Button(root, image=Volume1,bg="#FFFFFF", bd=0, height=60, width=60, command=mixer.music.unpause).place(x=20,y=487)
ButtonPause=PhotoImage(file="pause1 (1).png")
Button(root, image = ButtonPause, bg="#FFFFFF", bd=0, height=60, command=mixer.music.pause).place(x=300,y=487)
...
Button(root, text = "Browse Music", width=59,height=1, font=("calibri",12),fg="Black",bg="#FFFFFF",command=AddMusic).place(x=0,y=550)
